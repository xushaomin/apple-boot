...
import com.appleframework.boot.SpringContainer;
import com.appleframework.boot.StartUpInit;
...
public class ContainerManagerTest {
	...
	private static Logger logger = LoggerFactory.getLogger(ContainerManagerTest.class);
