package com.appleframework.boot.tomcat.core;
...
public class TomcatAttribute  implements Attributes {

	private static Logger logger = LoggerFactory.getLogger(TomcatAttribute.class);

	private static final String PROPERTIES_FILE_NAME = "tomcat.properties";
	...
	static {
		try {
			...
			logger.error("error happen when loading tomcat properties file");
		}
	}
